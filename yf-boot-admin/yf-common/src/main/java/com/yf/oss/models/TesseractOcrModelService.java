package com.yf.oss.models;

import com.yf.utils.TensorflowUtil;
...
public class TesseractOcrModelService {
    ...
    public TesseractOcrModelService() {
        try {
            ...
            File tempModelDir = Files.createTempDirectory("tess_data").toFile();
            TensorflowUtil.copyResource2TempDir("tess_data", tempModelDir.toPath());
            String folderPath = tempModelDir.getAbsolutePath();
            log.info("tess_data 临时文件路径 : {}", folderPath);
            /*
