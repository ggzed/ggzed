...
public class ChatRoomHandler extends BaseWebSocketHandler {
    ...
    @Autowired
    public ChatRoomHandler(RedisUtil redisUtil, RedissonClient redissonClient, SystemConfiguration systemConfiguration, ISocketMessageService socketMessageService, IOperateLogService operateLogService, ChatHandelMsgContext handelMsgContext, SensitiveWordBs sensitiveWordBs, PlatformTransactionManager transactionManager, ObjectMapper objectMapper) {
        super(redisUtil, redissonClient, systemConfiguration, socketMessageService, operateLogService, transactionManager, objectMapper);
        // 权限校验器
