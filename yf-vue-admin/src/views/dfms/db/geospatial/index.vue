    ...
    <div class="app-container">
      <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
        <el-tab-pane label="数据库管理" name="first">
          <!--  Search  -->
          <dfms-db-geospatial-search
              v-model:query="query"
              :load-data="loadData"
              :reset-query="resetQuery"
          />
          <!--  Table  -->
          <dfms-db-geospatial-table
              v-model:query="query"
              :data-list="dataList"
              :load-data="loadData"
              :loading="loading"
        ...
        <el-tab-pane label="空间表管理" name="second">
          <table-manage/>
        </el-tab-pane>
        <el-tab-pane label="空间查询" name="third">
          <sql-search/>
        </el-tab-pane>
        <el-tab-pane label="地图可视化" name="four">
          <sql-search/>
        </el-tab-pane>
      </el-tabs>
    </div>
