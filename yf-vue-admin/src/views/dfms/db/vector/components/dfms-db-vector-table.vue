<template>
    <el-card class="table-container">
        ...
        <template #header>
            <div>
                <el-button v-permission="[DfmsDbAPI.SAVE.permission]"
                    ...
                    <span v-show="device !== DeviceEnum.MOBILE"> 创建新向量集合 </span>
                </el-button>
        ...
        >
            ...
            <el-table-column align="center" label="类型(1-pgs" prop="type">
                <template #default="scope">
                    <el-tag type="primary">{{ scope.row.type }}</el-tag>
                </template>
            </el-table-column>
            <el-table-column align="center" label="维度(vecto" prop="dimension"/>
            <el-table-column align="center" label="向量数量(vec" prop="vectorNumber">
                <template #default="scope">
                    <el-tag type="primary">{{ scope.row.vectorNumber }}</el-tag>
                </template>
            </el-table-column>
            <el-table-column align="center" label="索引类型(vec" prop="indexType">
                <template #default="scope">
