...
export class DatabaseAPI {
    ...
    static OVERVIEW = {
        endpoint: `${API_SUFFIXES.OVERVIEW}`,
        request: (): AxiosPromise<HotApiVO> => {
            return axios.get<HotApiVO>(DatabaseAPI.HOT_LIST.endpoint);
        }
    }
    ...
    static WEATHER = {
        ...
        request: (): AxiosPromise<WeatherData> => {
            return axios.get<WeatherData>(DatabaseAPI.WEATHER.endpoint);
        }
    }
    ...
    static VISIT_TREND = {
        ...
        request: (startDate: string, endDate: string): AxiosPromise<VisitTrendVO> => {
            return request<VisitTrendVO>({
                url: DatabaseAPI.VISIT_TREND.endpoint,
                method: "get",
